...
use App\Filament\App\Resources\PetResource\Pages;
use App\Filament\App\Resources\PetResource\RelationManagers;
use App\Models\Pet;
use Filament\Forms;
...
class PetResource extends Resource
{
    ...
    {
        return static::getModel()::whereHas('treatments',function(Builder $query){
            $query->where('user_id', auth()->user()->id);
        })->count();
